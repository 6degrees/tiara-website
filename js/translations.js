...
var translations = {
  en: {
    ...
    stylingSpaceDescription: "In our styling lounge, light wooden chairs surround a central table adorned with fresh flowers. The soft, intimate lighting creates a welcoming atmosphere where conversations flow and personal style is discovered. Every detail invites you to pause and feel at home.",
    sereneHorizons: "SERENE HORIZONS",
    spaSpaceDescription: "Our spa relaxation area offers comfortable recliners positioned to face expansive windows, framing views of water and landscape beyond. This tranquil corner invites deep rest, where the boundary between interior comfort and natural beauty dissolves into perfect peace.",
    
    // Products Section
    ourProducts: "OUR PRODUCTS",
    productsDescription: "Carefully curated skincare and beauty products that extend the Tiara ritual into your daily routine. Each product is crafted with pure ingredients and intentional care.",
  ...
  ar: {
    ...
    // Hero Section
    beautyAsRitual: "الجمال كطقوس",
    theRitualOfBeingCrowned: "طقوس التتويج",
    heroSubtitle: "تعيد تيارا تعريف العناية الذاتية كمراسم هادئة — حيث تلتقي الجمال والتوازن والأصالة.",
    ...
    // Services Section
    ourRitualServices: "خدماتنا الطقسية",
    facialTreatments: "علاجات الوجه",
    ...
    intimateElegance: "أناقة حميمة",
    stylingSpaceDescription: "في صالة التصفيف لدينا، تحيط الكراسي الخشبية الخفيفة بطاولة مركزية مزينة بزهور طازجة. الإضاءة الناعمة والحميمة تخلق جوًا مرحبًا حيث تتدفق المحادثات ويُكتشف الأسلوب الشخصي. كل تفصيلة تدعوك للتوقف والشعور بالراحة في المنزل.",
    sereneHorizons: "آفاق هادئة",
    spaSpaceDescription: "تقدم منطقة الاسترخاء في السبا لدينا كراسي مريحة موضوعة لمواجهة نوافذ واسعة، مؤطرة مناظر الماء والمناظر الطبيعية خلفها. هذا الركن الهادئ يدعو للراحة العميقة، حيث يذوب الحد بين الراحة الداخلية والجمال الطبيعي في سلام مثالي.",
    
    // Products Section
    ourProducts: "منتجاتنا",
    productsDescription: "منتجات العناية بالبشرة والجمال المختارة بعناية التي تمتد بطقوس تيارا إلى روتينك اليومي. كل منتج مصنوع بمكونات نقية وعناية متعمدة.",
    ...
    // Footer
    footerDescription: "تعيد تيارا تعريف العناية الذاتية كمراسم هادئة حيث تلتقي الجمال والتوازن والأصالة.",
    instagram: "إنستغرام",
    bookNow: "احجز الآن",
